...
/** Builds the prop bag passed to the active layout shell (Brewlate). */
export function useAppLayoutProps(props) {
  ...
  return useMemo(() => ({
    ...
    budgetExhausted,
    qualityPassTarget,
    onQualityPassTargetChange: setQualityPassTarget,
  }), [
    online, activeAgents, modes, activeMode, kvReadings, kvFetchFailed, hostMemory,
    responses, agentErrors, finalAnswer, loading, error, history, lastMeta,
    ...
    handleSwitchSession, handleForked, handleSaveCode, setFlatPickAgent, handleSendBestContinue, handleExpandProgrammer,
